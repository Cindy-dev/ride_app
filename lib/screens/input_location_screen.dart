...
class _InputLocationState extends State<InputLocation> {
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Padding(
                  ...
                  child: Text('Enter pick-up location',
                    style: TextStyle(
            ...
            Card(
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: ListTile(
                    leading: Icon(Icons.location_on, color: Colors.deepPurple.shade700,size:20,),
                      title: TextField(
  ...
  void findPlace(String placeName) async{
    if(placeName.length > 1){
      String autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$GOOGLE_API_KEY&sessiontoken=1234567890&components=country:ng";
